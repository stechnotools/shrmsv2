		...
		<div class="card">
			<div class="card-header py-2 text-white">
				...
				<div class="panel-tools float-right">
					<button type="submit" data-toggle="tooltip" title="<?php echo $button_save; ?>" class="btn btn-danger btn-sm" form="form-grade"><i class="fa fa-save"></i></button>
			...
			<div class="card-body">
				<?php echo form_open_multipart("",array('class' => 'form-horizontal', 'id' => 'form-grade','role'=>'form')); ?>
				<div class="form-group row required">
					<label class="col-md-2 control-label" for="input-firstname">Grade Name</label>
					<div class="col-md-10">
				...
				<div class="form-group row required">
					<label class="col-md-2 control-label" for="input-code">Grade Code</label>
					<div class="col-md-10">
