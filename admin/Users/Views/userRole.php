		...
		<div class="card">
			<div class="card-header py-2 text-white">
				...
				<div class="panel-tools float-right">
					...
					<button type="button" data-toggle="tooltip" title="Delete" class="btn btn-danger btn-sm" onclick="confirm('<?php echo $text_confirm; ?>') ? $('#form-role').submit() : false;"><i class="fa fa-trash"></i></button>
				</div>
			</div>
			<div class="card-body">
                <form action="<?php echo $delete; ?>" method="post" enctype="multipart/form-data" id="form-role">          
					<div class="row">
