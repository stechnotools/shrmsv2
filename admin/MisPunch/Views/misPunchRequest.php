								...
								<tbody>
									<?php if($mispunches){
										...
										<tr>
											...
											<td>
												<?php if($mispunch['is_request'] == 0 && $mispunch['is_request'] !=null){?>
												<span class="badge badge-primary">Requested</span>
												<?}else{?>
												<a href="<?php echo admin_url('mispunch/requestpop?user_id='.$mispunch['user_id'].'&punch_date='.$mispunch['punch_date']); ?>" class="btn btn-danger btn-sm ajaxaction">Request</a>
												<?}?>
											</td>
										</tr>
									<?}}?>
