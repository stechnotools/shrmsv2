  ...
  <table class="table table-bordered">
    ...
    <tbody>
		...
		<tr>
			...
			<td></td>
			<td><a class="btn-sm btn btn-danger btn-remove" href="<?php echo admin_url('punch/deletehistory/'.$punch['id']);?>" onclick="return confirm('Are you sure?') ? true : false;"><i class="fa fa-trash"></i></a>
			</td>
		</tr>
		<?}?>
		<?}else{?>
