...
{	
   public function __construct(){
	...
	public function editPromotion($arrear_id, $data) {
		$arreardata=array(
			"ctc"=>$data['ctc'],
			"basic"=>$data['basic'],
			"da"=>$data['da'],
	...
	public function getTotalPromotions($data = array()) {
		$this->db->from("employee_payroll ep");
		$this->db->join('employee_office eo', 'eo.user_id = ep.user_id','left');
	...
	public function deletePromotion($user_id){
		$this->db->where_in("user_id", $user_id);
		$this->db->delete("employee_payroll");
	}
	
	public function getPromotionSheets($data = array()){
	...
	public function getPromotionSheet($user_id,$month){
	...
	public function getSiteAttendancePromotions($attendance_id,$designation_id) {
