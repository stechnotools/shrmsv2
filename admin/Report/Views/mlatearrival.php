	...
	<div class="col-lg-12">
		<div class="card">
			<div class="card-header">
				<h3 class="card-title float-left">Monthly Late Report</h3>
...
<div class="row">
	<div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title text-center">Monthly Late Report</h3>
            </div>
            <div class="card-body">
                <?php if($mlatedata){?>
                <table class="table" id="datatable">
					<thead>
						<tr>
							...
							<th colspan="2">Total Late</th>
							<th colspan="2">Total Late Day</th>
					...
					<tbody>
						<?php $i=1;foreach($mlatedata as $key=>$value){?>
						<tr>
							<td><?php echo $i;?></td>
							...
							<td><?php echo $value['details']['total_morning_day'];?></td>
							<td><?php echo $value['details']['total_lunch_day'];?></td>
							<?php foreach($months as $column){?>
							<td><?php echo $value['dates'][$column['date']]['late_arrival'];?></td>
							<td><?php echo $value['dates'][$column['date']]['excess_lunch'];?></td>
							<?php }?>
