	...
	<div class="col-lg-12">
		<div class="card">
			<div class="card-header">
				<h3 class="card-title float-left">Spot Late Arrival Report</h3>
...
<div class="row">
	<div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title text-center">Early Late Report</h3>
            </div>
            <div class="card-body">
                <?php if($latearrival){?>
                <table class="table text-center" id="datatable">
					...
					<tbody>
					<?php foreach ($latearrival as $key => $spot) { ?>
						<tr>
