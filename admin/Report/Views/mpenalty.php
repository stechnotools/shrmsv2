...
<div class="row">
	<div class="col-lg-12">
		<div class="card">
			...
			<div class="card-body">
				<form action="" method="post" enctype="multipart/form-data" id="form-attendance">
					<div class="row">
						<div class="col-lg-4">
							<div class="form-group">
								<label for="inputEmail3" class="control-label">Date</label>
								<?php echo form_input(array('id'=>'daterange','name'=>'filter[daterange]', 'class'=>'form-control daterange','placeholder'=>'Date Range','value' => set_filter('attendance', 'daterange'),'required'=>true)) ?>
							</div>
						</div>
						<div class="col-lg-4">
							<div class="form-group">
								<label class="control-label" for="input-email">Branch</label>
								<?php echo form_dropdown('filter[branch_id]', option_array_value($branches, 'id', 'name',array(''=>'All Branch')), set_filter('attendance','branch_id'),"id='branch_id' class='form-control select2' required"); ?>
							</div>
						</div>
						<div class="col-lg-4">
							<div class="form-group row">
								<label for="inputEmail3" class="control-label">Emp Name/Paycode</label>
								<?php echo form_dropdown('filter[user_id][]', option_array_value($employees, 'id', 'employee_name'), set_filter('attendance','user_id'),"id='user_id' class='form-control select2' multiple"); ?>
							</div>
						</div>
					</div>
				</form>
...
<div class="row">
	<div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title text-center">Penalty Report</h3>
            </div>
            <div class="card-body">
                <?php if($musterroll){?>
                <table class="table row-border order-column" id="datatable">
					...
					<tbody>
						...
						<tr>
							...
							<td><?php echo $value['details']['total_penalty'];?></td>
						</tr>
						<?$i++;}?>
					</tbody>
				</table>
