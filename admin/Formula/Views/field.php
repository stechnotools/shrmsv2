				...
				<form action="<?php echo $delete; ?>" method="post" enctype="multipart/form-data" id="form-field">          
					<div class="row">
						<div class="col-md-12 col-sm-12 col-12">
							<table id="field_list" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
								<thead>
									<tr>
	...
	$('#field_list').DataTable({
		...
		"ajax":{
			...
			error: function(){  // error handling
				$(".field_list_error").html("");
				$("#field_list").append('<tbody class="field_list_error"><tr><th colspan="3">No data found.</th></tr></tbody>');
				$("#field_list_processing").css("display","none");
