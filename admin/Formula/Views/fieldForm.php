		...
		<div class="card">
			...
			<div class="card-body">
				...
				<div class="form-group row required">
					<label class="col-md-2 control-label" for="input-firstname">Field Group Name</label>
					<div class="col-md-10">
						<?php  echo form_dropdown('group', $field_groups, set_value('group',$group),array('class'=>'form-control select2','id' => 'group')); ?>
						<?php echo $validation->showError('group', 'aio_error'); ?>
					</div>
				</div>
				<div class="form-group row required">
				...
				<div class="form-group row required">
					<label class="col-md-2 control-label" for="input-code">Field Code</label>
					<div class="col-md-10">
